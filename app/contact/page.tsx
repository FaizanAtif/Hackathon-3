...
const Contact = () => {
  return (
    ...
    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start">
  {/* Wrapper for iframe and content */}
  <div className="w-full h-full relative">
    ...
    <iframe
      ...
      style={{ filter: "contrast(1) opacity(100%)" }}
    />
    {/* Content */}
    <div className="bg-white flex flex-wrap py-6 rounded shadow-md absolute bottom-0 left-0 w-full z-10">
