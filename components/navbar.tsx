    ...
    <div className="navbar bg-base-100">
      <div className="navbar-start flex items-center">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box mt-3 w-52 p-2 shadow-md z-10">
            <li><a>Item 1</a></li>
            <li>
              <a>Parent</a>
              <ul className="p-2">
      ...
      <div className="navbar-end flex">
        <div className="relative text-gray-900 lg:block hidden">
          ...
          <button type="submit" className="absolute right-0 top-0 mt-3 mr-4">
            <svg className="h-4 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56.966 56.966">
